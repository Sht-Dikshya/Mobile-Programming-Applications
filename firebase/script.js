...
writeUserData(1, "Dikshya", "Shrestha", "dikshya@example.com", "1234567890", 25);
writeUserData(2, "Smriti", "Shrestha", "smriti@example.com", "1234567890", 25);
writeUserData(3, "Liza", "Shrestha", "liza@example.com", "1234567890", 25);
...
function updateUserData(userId, updatedData) {
  ...
  //Example usage;
  updateUserData(1, { firstname: "Dikshya", lastname: "Shrestha", email: "dikshya@westcliff.com", age: 22 });
  updateUserData(2, { firstname: "Smriti", lastname: " Shrestha", email: "smriti@gmail.com", age: 23 });
  updateUserData(3, { firstname: "Liza", lastname: " Shrestha", email: "liza@gmail.com", age: 24 });
